...
void blToolExec::setBinariesDir(QString dir){
    m_binariesDir = dir;
}
...
void blToolExec::run(){
    ...
    int processId = getNextIndexFile("history_");
  ...
  cmd = cmd.replace("/", "\\");
        ...
        emit progressOutput(processId, m_outputDir, m_inputsInfo, m_outputData, m_parameters, m_toolInfo);
    }
    ...
    */
    ...
    emit processFinished(processId, m_toolInfo->name());
